...
# Win
if os.name == 'nt':
    dll_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'win', 'x64')
    os.add_dll_directory(dll_path)

if os.name == 'darwin':
    dylib_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'mac'))
    os.add_dll_directory(dylib_path)
